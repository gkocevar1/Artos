...
class ProgramConstants
{
  public:
    // Valves constants
    const static int _valve1P = 20;
    const static int _valve1M = 21;
    const static int _valve2P = 23;
    const static int _valve2M = 25;
    const static int _valve3P = 27;
    const static int _valve3M = 29;
    const static int _valve4P = 31;
    const static int _valve4M = 33;
    const static int _valve5P = 35;
    const static int _valve5M = 37;
